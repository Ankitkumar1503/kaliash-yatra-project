...
export default function TripNavTabs({
  ...
  return (
    <div className={`max-w-[1360px] mx-auto bg-[#F8F8F8] py-2 sm:py-3 px-3 sm:px-4 lg:px-2 xl:px-1 sticky top-0 z-30 rounded-full`}>
      <div className="max-w-[1360px] mx-auto">
        <div className="flex justify-evenly items-center overflow-x-auto no-scrollbar py-1 space-x-2 sm:space-x-3">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-[16px] font-medium transition-all duration-200 whitespace-nowrap cursor-pointer shrink-0 ${
                  isActive
