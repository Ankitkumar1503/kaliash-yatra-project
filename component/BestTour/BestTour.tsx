      ...
      <div className="max-w-[1360px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 sm:mb-8 mx-auto gap-4 sm:gap-0">
          ...
          >
            ...
            <span className="transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform text-xs">
              <FaArrowRight className="w-3 h-3 text-gray-700" />
            </span>
          </Link>
        </div>
        ...
        <div className="relative mx-auto">
          ...
          <button
            ...
            className="absolute -left-3 sm:-left-5 top-1/3 -translate-y-1/2 z-20 bg-white text-gray-800 p-2.5 rounded-full shadow-md border border-gray-100 hover:bg-gray-50 transition-all opacity-90 hover:opacity-100 hidden sm:flex items-center justify-center focus:outline-none cursor-pointer"
          >
            ...
            {tourData.map((tour) => (
              ...
              >
                ...
                <div className="relative overflow-hidden aspect-square w-full shadow-2xs group-hover/card:shadow-md transition-shadow bg-gray-100">
                  ...
                  {/* Top-Left Badge */}
                  <span className="bg-[#FFC107] text-black text-[11px] font-semibold px-2.5 py-1 absolute top-3 left-0 z-10 shadow-2xs tracking-wider uppercase">
                    {tour.badge}
                  </span>
                ...
                <div className="pt-3 flex flex-col space-y-0.5">
                  {/* Title */}
                  <h3 className="font-semibold text-black text-xs sm:text-[14px] line-clamp-1 group-hover/card:text-[#F26522] transition-colors leading-snug">
                    {tour.title}
                  </h3>

                  {/* Location Subtext */}
                  <p className="text-gray-500 text-[11px] sm:text-xs font-normal">
                    {tour.location}
                  </p>
                  ...
                  <div className="flex items-center gap-1.5 pt-1 flex-wrap">
                    {/* Rating Badge */}
                    <span className="bg-[#F26522] text-white font-semibold px-1.5 py-0.5 text-[11px] rounded-xs">
                      {tour.rating.toFixed(1)}
                    </span>

                    {/* 5 Filled Stars */}
                    <div className="flex items-center text-amber-400 text-[11px] space-x-0.5">
                      {[...Array(5)].map((_, i) => (
                        <FaStar key={i} />
                      ))}
                    </div>
                  ...
                  {/* Price Line */}
                  <div className="pt-1 text-xs text-gray-700 flex items-center">
                    <span>Starting from</span>
                    <span className="text-[#F26522] font-semibold text-xs sm:text-sm ml-1.5">
                      {tour.price}
                    </span>
                  </div>
                </div>
          ...
          <button
            ...
            className="absolute -right-3 sm:-right-5 top-1/3 -translate-y-1/2 z-20 bg-[#F26522] hover:bg-[#d85417] text-white p-2.5 rounded-full shadow-md transition-all opacity-90 hover:opacity-100 hidden sm:flex items-center justify-center focus:outline-none cursor-pointer"
          >
